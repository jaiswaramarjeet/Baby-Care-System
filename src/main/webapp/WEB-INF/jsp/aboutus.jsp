...
<div class="row">
  ...
  <div class="col-6 col-s-9">
    <h1>Aboutus</h1>
    <p>The main goal is to provide the best suggestion & care options to parents of new born baby or we can say that application helps new parents. Parents can take counselling also from online counselor. Application have a good team of writers for blog which writes various articles on Food, Diet, Baby Care, Mother Care etc. Proposed system is accessed by two entities namely Admin and User. This system is to provide user friendly environment to search all type answers raise by parents regarding perinatal care issue.</p>
